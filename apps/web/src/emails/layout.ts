...
export function emailLayout(input: { preview: string; title: string; greeting: string; body: string; actionLabel: string; actionUrl: string; footer: string }) {
