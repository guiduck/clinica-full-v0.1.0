...
export function AuthBrandPanel() {
  return (
    <aside className="hidden min-h-screen bg-primary p-12 text-primary-foreground lg:flex lg:flex-col lg:justify-between">
      <div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-white/15 font-bold">{SITE_LOGO_TEXT}</span><span className="text-lg font-semibold">{SITE_NAME}</span></div>
